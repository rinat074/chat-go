...
func (s *AuthService) generateTokenPair(userID int64, username string) (*models.TokenPair, error) {
...
func (s *AuthService) RefreshToken(ctx context.Context, refreshToken, userAgent, ip string) (*models.TokenPair, error) {
...
// Logout выход из системы, удаление refresh токена
